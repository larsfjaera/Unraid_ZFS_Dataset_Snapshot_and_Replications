...
perform_backup() {
    ...
    local autosnapshots="$5"
    local snapshot_hours="$6"
    local snapshot_days="$7"
    local snapshot_weeks="$8"
    local snapshot_months="$9"
    local snapshot_years="${10}"
    local destination_remote="${11}" 
    local remote_user="${12}" 
    local remote_server="${13}" 
    local replication="${14}" 
    local destination_pool="${15}" 
    local parent_destination_dataset="${16}" 
    local syncoid_mode="${17}" 
    local parent_destination_folder="${18}" 
    local rsync_type="${19}" 
    local source_path="${20}" 
    local zfs_destination_path="${21}" 
    local destination_rsync_location="${22}" 
    local sanoid_config_dir="${23}" 
    local sanoid_config_complete_path="${24}" 
    #
    ####################
    #
...
source_pool="electron"  #this is the zpool in which your source dataset resides (note the does NOT start with /mnt/)
source_dataset="test1"   #this is the name of the dataset you want to snapshot and/or replicate
...
destination_pool="disk6"  #this is the zpool in which your destination dataset will be created
parent_destination_dataset="backups" #this is the parent dataset in which a child dataset will be created containing the replicated data (zfs replication)
...
# Run backup
perform_backup $notification_type $notify_tune $source_pool $source_dataset $autosnapshots $snapshot_hours $snapshot_days $snapshot_weeks $snapshot_months $snapshot_years $destination_remote $remote_user $remote_server $replication $destination_pool $parent_destination_dataset $syncoid_mode $parent_destination_folder $rsync_type $source_path $zfs_destination_path $destination_rsync_location $sanoid_config_dir $sanoid_config_complete_path

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
##   POOL: electron   DATASET: test2                                                                                                      # #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
notification_type="all" 
notify_tune="yes"  
source_pool="electron"  
...
replication="zfs"   
destination_pool="disk6"
parent_destination_dataset="backups" 
syncoid_mode="strict-mirror"
parent_destination_folder="/mnt/user/rsync_backup"
